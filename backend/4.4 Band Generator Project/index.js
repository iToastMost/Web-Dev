...
app.post("/submit", (req, res) => {
  var randomAdjNum = Math.floor(Math.random() * adj.length - 1);
  var randomNounNum = Math.floor(Math.random() * noun.length - 1);

  const randomName = adj[randomAdjNum] + " " + noun[randomNounNum];
